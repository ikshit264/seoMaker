...
const CARDS: CardData[] = [
  ...
  },
  {
    ...
    content: "The native MongoDB integration is a game changer. Total data ownership combined with a world-class UI — exactly what we needed.",
    avatar: "SC"
  },
  {
    id: 3,
    ...
    <div className="relative w-full max-w-xl h-[400px] flex items-center justify-center perspective-[1500px]">
      <AnimatePresence mode="popLayout">
        {cards.map((card, index) => {
          // Only show the top 3 cards for a clean stack
